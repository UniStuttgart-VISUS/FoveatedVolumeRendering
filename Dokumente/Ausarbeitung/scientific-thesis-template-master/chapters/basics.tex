...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{../../Grafiken/Ausführungsmodell-GPU-Architektur.png}
...
Das Platform Modell besteht aus einem Host, OpenCL Devices und Compute Units mit jeweils ein oder mehreren Processing Elements.
