...
Die Slice-Dicke der einzelnen Voxel ist $1,0\times1,0\times1,0$, dass heißt, dass die Voxel in x-, y- und z-Richtung die gleiche Skalierung haben.
...
Die Abtastrate der Strahlen hat den Standardwert von $1.5$.
Die Abtastdistanz wird mit $1 \times Voxellänge \div Abtastrate$ berechnet, dass heißt in diesem Fall wird Strahl alle $\frac{1}{1,5}$\,Längeneinheiten abgetastet.
...
Abbildung \ref{fig::res::sup_st} zeigt eine Berechnung des Volumens der Supernova im Zeitschritt $1353$.
