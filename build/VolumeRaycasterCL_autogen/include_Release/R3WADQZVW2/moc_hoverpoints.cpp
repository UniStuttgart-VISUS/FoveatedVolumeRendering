...
QT_MOC_LITERAL(6, 57, 10), // "setEnabled"
QT_MOC_LITERAL(7, 68, 7), // "enabled"
QT_MOC_LITERAL(8, 76, 11), // "setDisabled"
QT_MOC_LITERAL(9, 88, 8), // "disabled"
QT_MOC_LITERAL(10, 97, 16) // "setColorSelected"

    },
    "HoverPoints\0pointsChanged\0\0points\0"
    "selectionChanged\0color\0setEnabled\0"
    "enabled\0setDisabled\0disabled\0"
    "setColorSelected"
};
...
void HoverPoints::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->selectionChanged((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 2: _t->setEnabled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->setDisabled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->setColorSelected((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (HoverPoints::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HoverPoints::selectionChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void HoverPoints::selectionChanged(const QColor & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
